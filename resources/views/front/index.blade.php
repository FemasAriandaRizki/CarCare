...
<html>
    ...
    <body>
        ...
        >
            ...
            ></div>
            <header
                class="flex flex-col gap-3 items-center text-center pt-10 relative z-10"
            >
                <div class="flex shrink-0">
                    <img
                        src="{{ asset('assets/images/logos/logo.svg') }}"
                        alt="logo"
                    />
                </div>
                <p class="text-sm leading-[21px] text-white">
                    Premium Wash & Car Detailing
                </p>
            </header>
            <form action="" class="flex flex-col gap-6 mt-6 relative z-10">
                <div class="flex flex-col gap-2 px-4">
                    <label for="Location" class="font-semibold text-white"
                        >Location</label
                    >
                    <div
                    ...
                    >
                        <div class="w-6 h-6 flex shrink-0 mr-[6px]">
                            <img
                                src="{{
                                    asset(
                                        'assets/images/icons/location-normal.svg'
                                    )
                                }}"
                                alt="icon"
                            />
                        ...
                        <a href="#" class="service-link card-services">
                            ...
                            >
                                ...
                                <div class="flex flex-col">
                                    <p
                                        class="font-semibold text-sm leading-[21px]"
                                    >
                                        {{ $service->name }}
                                    </p>
                                    <p
                                        class="text-xs leading-[18px] text-[#909DBF]"
                                    >
            ...
            <section
                id="Promo"
                class="flex flex-col gap-3 px-4 mt-6 relative z-10"
            >
                ...
                <a href="#">
                    ...
                    >
                        <img
                            src="{{
                                asset('assets/images/thumbnails/banner.png')
                            }}"
                        ...
                        >
                            <div class="w-6 h-6 flex shrink-0">
                                <img
                                    src="{{
                                        asset(
                                            'assets/images/icons/element-equal.svg'
                                        )
                                    }}"
                                    alt="icon"
                                />
                            ...
                            <p
                                class="font-semibold text-xs leading-[18px] text-[#FF8969]"
                            >
                                Home
                            </p>
                        </a>
                        ...
                        >
                            <div class="w-6 h-6 flex shrink-0">
                                <img
                                    src="{{
                                        asset(
                                            'assets/images/icons/note-favorite-grey.svg'
                                        )
                                    }}"
                                    alt="icon"
                                />
                            ...
                            <p
                                class="font-semibold text-xs leading-[18px] text-[#BABEC7]"
                            >
                                Orders
                            </p>
                        </a>
                        ...
                        >
                            <div class="w-6 h-6 flex shrink-0">
                                <img
                                    src="{{
                                        asset(
                                            'assets/images/icons/ticket-discount-grey.svg'
                                        )
                                    }}"
                                    alt="icon"
                                />
                        ...
                        >
                            <div class="w-6 h-6 flex shrink-0">
                                <img
                                    src="{{
                                        asset(
                                            'assets/images/icons/message-question-grey.svg'
                                        )
                                    }}"
                                    alt="icon"
                                />
